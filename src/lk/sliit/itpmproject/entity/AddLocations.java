...
public class AddLocations implements SuperEntity{
    private int id;
    ...
    public AddLocations(int id, String buildingName, String roomName, boolean lectureHall, boolean laboratory, String capacity) {
        this.id = id;
