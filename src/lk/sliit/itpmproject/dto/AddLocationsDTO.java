...
public class AddLocationsDTO {
    ...
    public AddLocationsDTO() {
    }

    public AddLocationsDTO(int id, String buildingName, String roomName, boolean lectureHall, boolean laboratory, String capacity) {
        this.id = id;
